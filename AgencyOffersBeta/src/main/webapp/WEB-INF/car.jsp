			...
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav">
						<a href="HomeS">Home </a> <span>To</span> <a href="CarS"> Cars</a>
					</p>
				</div>
			</div>
		</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="menu-content pb-40 col-lg-8">
					<div class="title text-center">
						<h1 class="mb-10">Popular Cars</h1>
						<p>Famous Cars with good prices are in your hand!</p>
					</div>
				</div>
			</div>
			<div class="row">
							...
							<div class="details">
								...
								<ul class="package-list">
									<li class="d-flex justify-content-between align-items-center">
										<span>seats</span> <span>${item.seat_number}</span>
									</li>
									<li class="d-flex justify-content-between align-items-center">
										<span>air conditioner</span> <span>${item.air_conditioner}</span>
									</li>
									<li class="d-flex justify-content-between align-items-center">
										<span>rating</span> <span>${item.rating}</span>
									</li>
									<li class="d-flex justify-content-between align-items-center">
										<span>days</span> <span>${item.day_number}</span>
									</li>
									<li class="d-flex justify-content-between align-items-center">
										<span>Total Price</span> <a href="#" class="price-btn">$${item.price_per_duration}</a>
									</li>
								</ul>
							</div>
						</div>
